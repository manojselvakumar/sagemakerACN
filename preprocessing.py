...
if __name__ == "__main__":
    ...
    column_transformer = make_column_transformer((["PAY_AMT1"], StandardScaler()), (["BILL_AMT1"], MinMaxScaler()), remainder="passthrough")
    
    print("Running preprocessing and feature engineering transformations")
    train_features = pd.DataFrame(column_transformer.fit_transform(X_train), columns=newcolorder)
    test_features = pd.DataFrame(column_transformer.transform(X_test), columns=newcolorder)
